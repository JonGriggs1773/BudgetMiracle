	...
	<div class = "container-custom">
		...
		<div class = "row h-100 justify-content-center align-items-center">
			<div class="card">
				...
				<div class="card-body">
					<h5 class="card-title">Input Your Monthly Income!!!</h5>
				</div>
				<div class = "row justify-content-md-center">
					<div class = "row h-100 justify-content-center align-items-center">
						<div class="form-floating mb-3">
							<form:form action = "/confirm/income" method = "post" modelAttribute = "income">
							...
							<form:input type="text" path = "source" class="form-control" id="floatingInput"/>
							...
							<div class = "pt-4">
		  						<input type = "submit" value = "Confirm Monthly Income" class = "btn btn-warning"/>
							</div>		  				
