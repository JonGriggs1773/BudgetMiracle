	...
	<div class = "container-custom">
		...
		<div class = "row h-100 justify-content-center align-items-center">
			<div class="card">
				...
				<div class="card-body">
					<h5 class="card-title">Input Your Expense Below!!!</h5>
				</div>
				<div class = "row justify-content-md-center">
					<div class = "row h-100 justify-content-center align-items-center">
						<div class="form-floating mb-3">
							<form:form action = "/confirm/new/expense" method = "post" modelAttribute = "expense">
								...
								<div class = "pt-4">
			  						<input type = "submit" value = "Confirm New Expense" class = "btn btn-danger"/>
								</div>		  				
				...
				<div class="card-footer text-muted">
					Expenses are the things you can take from to give yourself more financial room. Let us help.
				</div>
			</div>
		</div>
	</div>
