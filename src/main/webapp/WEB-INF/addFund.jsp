	...
	<div class = "container-custom">
		...
		<div class = "row h-100 justify-content-center align-items-center">
			<div class="card">
				...
				<div class="card-body">
					<h5 class="card-title">Input Your Fund Below!!!</h5>
				</div>
				<div class = "row justify-content-md-center">
					<div class = "row h-100 justify-content-center align-items-center">
						<div class="form-floating mb-3">
							<form:form action = "/confirm/new/fund" method = "post" modelAttribute = "fund">
								...
								<div class = "pt-4">
			  						<input type = "submit" value = "Confirm New Fund" class = "btn btn-danger"/>
								</div>		  				
				...
				<div class="card-footer text-muted">
					Funds are what you put back for emergencies and what you use to save 
					up for something you may really want. Like a vacation or a down payment 
					on a house
				</div>
			</div>
		</div>
